...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AgentPriorityHistory>(entity =>
        {
            ...
            entity.Property(e => e.ChangeDate).HasColumnType("timestamp(6) without time zone");
        ...
        modelBuilder.HasSequence("clients_client_id_seq");
        modelBuilder.HasSequence("diagnosis_diagnosis_id_seq");
        modelBuilder.HasSequence("medical_departments_medical_department_id_seq").HasMax(2147483647L);
        modelBuilder.HasSequence("users_type_user_type_id_seq").HasMax(2147483647L);
